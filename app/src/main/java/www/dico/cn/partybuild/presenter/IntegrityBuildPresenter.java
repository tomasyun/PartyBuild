...
public class IntegrityBuildPresenter extends BaseMvpPresenter<IntegrityBuildView> {
    public void doIntegrityBuildRequest(IProgressDialog dialog, String articleType, String childrenType, String draw, int start, int length) {
